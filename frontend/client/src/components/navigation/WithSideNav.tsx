        ...
        <>
            <header aria-label="Site Header" className="shadow-sm md:hidden">
                ...
                >
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <a href="#">
                            ...
                            <span className="h-10 w-20 font-medium">training_app</span>
                        </a>
                    </div>
                    ...
                    >
                        <Link to="/scores" className="text-gray-900">LeaderBoard</Link>
                        <Link to="/modules" className="text-gray-900" >Training Modules</Link>
                    </nav>
                ...
                <div className="border-t border-gray-100 lg:hidden">
                    ...
                    >
                        <Link to="/scores" className="flex-shrink-0 pl-4 text-gray-900">LeaderBoard</Link>
                        <Link to="/modules" className="flex-shrink-0 pl-4 text-gray-900" >Training Modules</Link>
                    </nav>
                </div>
            </header>
            <div className="App">
